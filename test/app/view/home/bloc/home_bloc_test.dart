...
void main() {
  group('HomeBloc Testing', () {
    ...
    final Map<String, dynamic> jsonData1 = {
      ...
      "is_closed": false,
      "url":
          "https://www.yelp.com/biz/eleven-madison-park-new-york?adjust_creative=BlndLX7A8uetp91dgJCDcw&utm_campaign=yelp_api_v3&utm_medium=api_v3_business_search&utm_source=BlndLX7A8uetp91dgJCDcw",
      "review_count": 2498,
      "categories": [
    ...
    test('initial state is RestaurantsLoading', () {
      expect(
        homeBloc.state,
        RestaurantsLoading(),
      );
